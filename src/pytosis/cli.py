...
def parse_cli() -> dict[str, Any]:
    ...
    parser.add_argument("file(s)", nargs="+") # There has to be at least one FITS file passed.
    parser.add_argument("-p", "--plot",
                        action="store_true",
                        help="Shows the plots for every function.")
    parser.add_argument("-f", "--filter-method",
